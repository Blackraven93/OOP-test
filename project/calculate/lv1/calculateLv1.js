...
import {
  handleStepOneOperator,
  handleStepTwoOperator,
...
const init = (btn, input) => {
  ...
  if (isNumber) {
    if (input.innerText === "0") {
      ...
      if (operator === "") {
        ...
        if (previousNumber === "") {
          ...
          log(operator, btn.innerText);
          log(currentNumber, btn.innerText);
          // 정확하게 어떤 오류가 나냐??
    ...
    if (previousNumber === "") {
      ...
      switch (operator) {
        case "+":
          input.innerText = previousNumber + currentNumber;
          currentNumber = input.innerText;
          previousNumber = "";
          operator = btn.innerText;
          break;
        ...
        case "x":
          ...
          break;
        case "/":
          input.innerText = Math.floor(previousNumber / currentNumber);
          currentNumber = input.innerText;
          previousNumber = "";
          operator = btn.innerText;
          break;
